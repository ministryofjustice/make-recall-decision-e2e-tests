...
# This is a copy of the script file with the same name in the UI repo, setting the environment variable values needed
# for the e2e tests to run using the new flag before we activate it officially. It should not be merged into main.
...
export SPRING_PROFILES_ACTIVE=dev,seed-test-data,e2e-test-repo-ftr56-offence-conviction
