...
export enum NewLicenceConditions {
  ...
  ADDRESS_APPROVED = 'Get permission from your supervising officer to stay at an address and if you want to stay somewhere else for one or more nights.',
